...
/* 窗口定义 */
lkdWin homeWin = {0,0,160,160,NULL,HomeFun,NULL};/* 桌面窗口 */
lkdWin menuWin = {0,0,160,160,"菜单窗口",MenuFun,NULL};/* 菜单窗口 */
lkdWin win0 = {0,0,160,160,"lkdGui介绍",Win0Fun,NULL};
lkdWin win1 = {0,0,160,160,"测试窗口",Win1Fun,NULL};
lkdWin win2 = {20,20,140,100,"测试窗口",Win2Fun,NULL};

/* 菜单节点定义 */
lkdMenuNode Node33 = {33,"二级菜单4", NULL,   NULL,NULL};
lkdMenuNode Node32 = {32,"二级菜单3", &Node33,NULL,NULL};
lkdMenuNode Node31 = {31,"二级菜单2", &Node32,NULL,NULL};
lkdMenuNode Node30 = {30,"二级菜单1", &Node31,NULL,&win2};
